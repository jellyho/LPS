...
def make_env_and_datasets(env_name, frame_stack=None, action_clip_eps=1e-5, droid_dir=None, droid_use_failure=False, sparse=False, horizon_length=5):
    ...
    if droid_dir is not None:
        ...
        dataset = droid_utils.load_droid_dataset(droid_path, include_failure=droid_use_failure, sparse=sparse, horizon_length=horizon_length)
